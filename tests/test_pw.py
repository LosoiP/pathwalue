...
class TestEvaluatePathway:
    ...
    def test_return_correct_value_ceil_16times14per3_steps_3(self):
        ...
        assert output == pw.pw.ceil(16 * 14 / 3)
...
class TestFormatCompound:
    ...
    compound = {'1': 1}
    output = pw.format_compound(compound, CONTEXT)
    ...
    def test_dict_not_changed_in_function(self):
        ...
        assert pw.format_compound(self.compound, CONTEXT) == correct

    def test_empty_data_empty_compound(self):
        assert pw.format_compound({}, CONTEXT) == {}

    def test_only_chebi_and_number_in_output_empty_context(self):
        output = pw.format_compound({'1': 1})
...
class TestFormatOutput:
    ...
    output = pw.format_output(results, CONTEXT)
...
class TestFormatPathway:
    ...
    value = 1
    reactions = ['1', '2', '4']
    output = pw.format_pathway(value, reactions, CONTEXT)
    output_no_context = pw.format_pathway(value, reactions)
    output_no_reactions = pw.format_pathway(value, [], CONTEXT)
...
class TestFormatReaction:
    ...
    rhea = '1'
    output = pw.format_reaction(rhea, CONTEXT)
    ...
    def test_only_rhea_in_output_empty_context(self):
        output = pw.format_reaction(self.rhea)
        correct = {
            'rhea': '1',
            'equation': '',
            'enzymes': {},
